...
import { X, ChevronLeft, ChevronRight, Maximize2, Trophy } from "lucide-react";

export default function AchievementsGallery() {
  // Eagerly load all achievements images from the assets folder
  const images = Object.values(
    import.meta.glob("../../assets/life/achievements/*.{png,jpg,jpeg}", {
      eager: true,
      import: "default",
    })
  ) as string[];
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-slate-600 text-sm sm:text-base">
              Honoring hard work, dedication, and success. Our galleries capture moments of prize distribution, award ceremonies, and accolades won by our bright students.
            </p>
          </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/95 backdrop-blur-md p-4">
            ...
            <div className="relative max-w-5xl w-full max-h-[85vh] flex flex-col items-center">
              <img
                ...
                alt={`Student achievement detail ${selectedIdx + 1}`}
