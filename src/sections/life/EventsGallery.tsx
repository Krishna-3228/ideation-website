...
export default function EventsGallery() {
  // Eagerly load all events images from the assets folder
  const images = Object.values(
    import.meta.glob("../../assets/life/events/*.{png,jpg,jpeg}", {
      eager: true,
      import: "default",
    })
  ) as string[];
  ...
  return (
    <section id="events" className="py-20 bg-white border-b border-slate-100">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 tracking-tight">
              Celebrations, Exhibitions & Gatherings
            </h2>
            <p className="mt-3 max-w-2xl text-slate-600 text-sm sm:text-base">
              A vibrant canvas of cultural programs, festivals, science fairs, workshops, and student celebrations that bring our community closer.
            </p>
          </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/95 backdrop-blur-md p-4">
            ...
            <div className="relative max-w-5xl w-full max-h-[85vh] flex flex-col items-center">
              <img
                ...
                alt={`Campus event detail ${selectedIdx + 1}`}
